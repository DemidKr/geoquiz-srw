...
export const QuestionCard: FC<QuestionCardProps> = ({question, deleteButton}) => {
    ...
    const handleDelete = async () => {
        if(question.id) {
            ...
            const response = await dispatch(deleteQuestion({
                url: '/question',
            ...
            addSnack(`Ошибка в удалении, попробуйте снова. Отсутствует id геоквиза`, 'error')
        }
        ...
        <Card sx={{ width: 400, minHeight: 400}} >
            ...
            <CardContent>
                <Grid container >
                    ...
                    <Grid item xs={12} sx={{marginTop: '8px'}}>
                        <Typography variant="body2" sx={{color: '#959595'}}>
                            Дата создания: {new Date(question.date).toLocaleDateString('en-GB')}
                        </Typography>
                    </Grid>
                    <Grid item xs={12} sx={{marginTop: '8px'}}>
                        <Button
                            sx={{backgroundColor: '#F36C41', color: 'white',
                ...
                <Grid container >
                    ...
                    <Grid container item xs={12} sx={{marginTop: '4px'}}>

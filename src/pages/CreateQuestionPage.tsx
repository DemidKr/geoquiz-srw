...
const CreateQuestionPage: FC = () => {
    const [currentCoordinates, setCurrentCoordinates] = useState<ICoordinates>(DEFAULT_COORDINATES)
    ...
    return (
        <>
            <Grid container style={{width: '100%'}}>
                <Grid item xs={12}>
                    <MapWrapper>
                        <Panorama point={[currentCoordinates.lat, currentCoordinates.lng]} style={{ width: '100%', height: `calc(100% - 80px)` }}
                                  defaultOptions={{
                                      direction: [-10, 0],
                                      controls: [],
